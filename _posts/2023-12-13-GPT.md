...
Additionally, for testing purpose, I have enumerated the system even further to look at the filesystem, find the OS and version and service running, open ports etc. After enumeration, it seems like it is a running in a container and I have also looked into ways of breaking out of the container, maybe I will post my trail and errors on breaking out of container to access host system in a seperate blog.
